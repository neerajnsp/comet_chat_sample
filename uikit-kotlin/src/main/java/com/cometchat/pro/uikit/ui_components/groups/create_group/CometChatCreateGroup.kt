...
class CometChatCreateGroup : Fragment() {
    ...
    private var groupType: String? = CometChatConstants.GROUP_TYPE_PRIVATE
...
//                startActivity(intent)
                ...
                groupMemberUids.add(group.owner)
                val intent = Intent(activity, CometChatAddMembersActivity::class.java)
                intent.putExtra(UIKitConstants.IntentStrings.GUID, group.guid)
                intent.putExtra(UIKitConstants.IntentStrings.GROUP_MEMBER, groupMemberUids)
                intent.putExtra(UIKitConstants.IntentStrings.GROUP_NAME, group.name)
