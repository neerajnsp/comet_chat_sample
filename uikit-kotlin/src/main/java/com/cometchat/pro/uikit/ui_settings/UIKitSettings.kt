...
class UIKitSettings(context: Context) {
    ...
    companion object {
        ...
        var searchUsers: Boolean = false
        var searchGroups: Boolean = false
        var searchMessages: Boolean = false
        ...
        var richMediaPreview: Boolean = false
        var voiceTranscription: Boolean = false
