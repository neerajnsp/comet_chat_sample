...
import com.cometchat.pro.uikit.databinding.AddMemberItemBinding
import com.cometchat.pro.uikit.ui_components.groups.add_members.AddChildInterface
import com.cometchat.pro.uikit.ui_components.shared.cometchatUsers.AddMemberAdapter.InitialHolder
import com.cometchat.pro.uikit.ui_components.shared.cometchatUsers.AddMemberAdapter.UserViewHolder
 ...
 *
 */
class AddMemberAdapter(context: Context,listener: AddChildInterface) : RecyclerView.Adapter<UserViewHolder>(), StickyHeaderAdapter<InitialHolder?> {
    ...
    private var  addChildInterface: AddChildInterface?=null
    /**
    ...
    init {
        ...
        this.addChildInterface=listener
    ...
    override fun onCreateViewHolder(parent: ViewGroup, i: Int): UserViewHolder {
        ...
        val userListRowBinding: AddMemberItemBinding = DataBindingUtil.inflate(layoutInflater, R.layout.add_member_item, parent, false)
    ...
    override fun onBindViewHolder(userViewHolder: UserViewHolder, i: Int) {
        ...
        userViewHolder.userListRowBinding.checkbox.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked){
                addChildInterface!!.add(user.uid)
            }
            else{
                addChildInterface!!.remove(user.uid)
            }
        }
    }
    ...
    inner class UserViewHolder(var userListRowBinding: AddMemberItemBinding) : RecyclerView.ViewHolder(userListRowBinding.root)
